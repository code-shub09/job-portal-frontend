...
// export default function ApplyJobModal({ job, resumePdf = null, setIsApplyClicked }) {
//   const [selectedResume, setSelectedResume] = useState(null);
//   const [uploadResume, setUploadResume] = useState(null);
...
//     mutate(form);
//     if (isSuccess) alert("Application submitted!");
//   }
...
//             {resumePdf && (
//               <div
//                 onClick={() => setSelectedResume({ type: "stored", data: resumePdf })}
//                 className={`border p-4 rounded-lg cursor-pointer flex justify-between items-center relative ${
//                   isSelected(resumePdf)
//                     ? "border-blue-500 bg-blue-50"
//                     : "border-gray-300 bg-gray-50 hover:bg-gray-100"
...
//                 <div className="mt-3">
//                   <p className="font-medium">{resumePdf.name}</p>
//                   <p className="text-xs text-gray-500">{formatKB(resumePdf.size)}</p>
//                 </div>
...
//             {uploadResume && (
//               <div
//                 onClick={() => setSelectedResume({ type: "new", data: uploadResume })}
//                 className={`border p-4 rounded-lg cursor-pointer flex justify-between items-center relative ${
//                   isSelected(uploadResume)
//                     ? "border-blue-500 bg-blue-50"
//                     : "border-green-500 bg-green-50 hover:bg-green-100"
...
//                 <div className="mt-3">
//                   <p className="font-medium">{uploadResume.name}</p>
//                   <p className="text-xs text-gray-600">{formatMB(uploadResume.size)}</p>
//                 </div>
