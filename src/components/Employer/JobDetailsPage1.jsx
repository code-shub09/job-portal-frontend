...
import ApplicantCard2 from "./AllApplication/ApplicantCard2";
...
export default function JobDetailsPage1() {
    ...
    isLoading || !job
      ...
      : [
          ...
          },
          {
            ...
            label: "Salary Range",
            value: `${job.salaryRange.min} - ${job.salaryRange.max} INR`,
    ...
    isLoading || !job
      ...
      : [
          ...
          },
          {
            icon: <HiUserGroup />,
            label: "Vacancies",
            value: job.vacancies || "Not provided",
      ...
      : [
          {
            ...
            value: job.stats.totalApplications,
            label: "Total Applications",
            color: "text-blue-600",
          },
          {
            icon: <TiStarOutline size={28} />,
            value: job.stats.shortlistedApplications,
            label: "Shortlisted",
            color: "text-yellow-500",
          },
          {
            icon: <FaCalendarCheck size={24} />,
            value: job.stats.InterviewApplications,
  ...
  const qualifications = [
    ...
    { icon: "fas fa-clock", text: "2-4 years of customer service experience" },
    {
      ...
      text: "Excellent verbal and written communication skills",
    },
    {
      icon: "fas fa-laptop",
      text: "Proficiency in CRM software and Microsoft Office",
    },
    {
        ...
        <div className="bg-gray-50 min-h-screen ">
          ...
          <main className="px-6 md:px-8 py-8 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to={`/job/all-application/${jobId}`}>
                ...
                <button
                  className="flex-1 px-6 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 font-medium"
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <ul className="space-y-2 ml-4">
                    {qualifications.map((q, idx) => (
                      <li key={idx} className="flex items-start">
                        <i
                          className={`${q.icon} text-blue-500 mt-1 mr-3 text-sm`}
                        />
                        <span>{q.text}</span>
                      </li>
                    ))}
            ...
            <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-blue-600 hover:text-blue-700 font-medium">
                  View All 500 Applications →
                </button>
              </div>

              <div className="overflow-x-auto">
                <div className="w-full flex flex-col gap-1">
                  {job.latestApplications.map((a, idx) => (
                    <ApplicantCard2 key={a.id} applicantX={a}></ApplicantCard2>
                  ))}
                </div>
              </div>
            </section>
          ...
          {IsSehButtonClick && (
            <div className="fixed inset-0 bg-black/50 z-40">
              <ScheduleInterviewModal2
                handleSchInterview={handleSchInterview}
                shortlistedApplications={job.shortlistedApplicants}
              ></ScheduleInterviewModal2>
            </div>
          )}
        </div>
